...
# 2. Calculate absolute change as the difference between 2022 and 2000.
table_df["Absolute Change"] = table_df["2022"] - table_df["2000"]
table_df.shape[1]

# 3. Calculate relative change as (absolute change / 2000 emissions) * 100.
...
```{python}
# Melt the original `emissions` dataset ...
...
# Query for 5 countries
countries_to_plot = ["China", "Australia", "India", "Peru", "Switzerland"]
emissions_long_subset = emissions_long_1990_2022[
    emissions_long_1990_2022["country"].isin(countries_to_plot)
]
...
# --- Mapping Section ---
# Convert country names to 3-letter ISO codes using country_converter.
